...
(function (MetalsTreeViewChildren) {
    MetalsTreeViewChildren.type = new vscode_languageserver_protocol_1.RequestType("metals/treeViewChildren");
...
(function (MetalsTreeViewDidChange) {
    MetalsTreeViewDidChange.type = new vscode_languageserver_protocol_1.NotificationType("metals/treeViewDidChange");
...
(function (MetalsTreeViewParent) {
    MetalsTreeViewParent.type = new vscode_languageserver_protocol_1.RequestType("metals/treeViewParent");
...
(function (MetalsTreeViewVisibilityDidChange) {
    MetalsTreeViewVisibilityDidChange.type = new vscode_languageserver_protocol_1.NotificationType("metals/treeViewVisibilityDidChange");
...
(function (MetalsTreeViewNodeCollapseDidChange) {
    MetalsTreeViewNodeCollapseDidChange.type = new vscode_languageserver_protocol_1.NotificationType("metals/treeViewNodeCollapseDidChange");
...
(function (MetalsTreeViewReveal) {
    MetalsTreeViewReveal.type = new vscode_languageserver_protocol_1.RequestType("metals/treeViewReveal");
