...
function getReaderValidation(S) {
    var T = ValidationT_1.getValidationM(S, Reader_1.monadReader);
 ...
 * @since 2.0.0
 */
exports.bimap = function (f, g) { return function (fa) { return T.bimap(fa, f, g); }; };
/**
 * @since 2.0.0
 */
 ...
 * @since 2.0.0
 */
exports.mapLeft = function (f) { return function (fa) { return T.mapLeft(fa, f); }; };
/**
 * @since 2.0.0
 */
