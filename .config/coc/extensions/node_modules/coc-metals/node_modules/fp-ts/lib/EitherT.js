...
function getEitherM(M) {
    ...
    return __assign(__assign({}, A), { chain: function (ma, f) { return M.chain(ma, function (e) { return (Either_1.isLeft(e) ? M.of(Either_1.left(e.left)) : f(e.right)); }); }, alt: function (fx, f) { return M.chain(fx, function (e) { return (Either_1.isLeft(e) ? f() : A.of(e.right)); }); }, bimap: function (ma, f, g) { return M.map(ma, function (e) { return Either_1.bifunctorEither.bimap(e, f, g); }); }, mapLeft: function (ma, f) { return M.map(ma, function (e) { return Either_1.bifunctorEither.mapLeft(e, f); }); }, fold: function (ma, onLeft, onRight) { return M.chain(ma, Either_1.fold(onLeft, onRight)); }, getOrElse: function (ma, onLeft) { return M.chain(ma, Either_1.fold(onLeft, M.of)); }, orElse: function (ma, f) {
