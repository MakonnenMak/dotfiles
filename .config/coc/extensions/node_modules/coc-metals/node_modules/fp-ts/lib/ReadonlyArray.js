...
var alt_ = function (fx, f) { return concat(fx, f()); };
...
var sequence_ = function (F) { return function (ta) {
    return reduce_(ta, F.of(zero_()), function (fas, fa) {
...
var traverseWithIndex_ = function (F) { return function (ta, f) {
    return reduceWithIndex_(ta, F.of(zero_()), function (i, fbs, a) {
