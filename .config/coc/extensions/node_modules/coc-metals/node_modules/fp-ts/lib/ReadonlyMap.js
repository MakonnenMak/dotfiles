...
var filterMap_ = function (fa, f) {
    return filterMapWithIndex_(fa, function (_, a) { return f(a); });
};
...
function getFilterableWithIndex() {
    return __assign(__assign({}, exports.readonlyMap), { _E: undefined, mapWithIndex: mapWithIndex_, partitionMapWithIndex: partitionMapWithIndex_, partitionWithIndex: partitionWithIndex_, filterMapWithIndex: filterMapWithIndex_, filterWithIndex: filterWithIndex_ });
}
...
function getWitherable(O) {
    ...
    return __assign(__assign({}, exports.readonlyMap), { _E: undefined, reduce: function (fa, b, f) { return reduceWithIndex(fa, b, function (_, b, a) { return f(b, a); }); }, foldMap: function (M) {
        ...
        sequence: sequence, mapWithIndex: mapWithIndex_, reduceWithIndex: reduceWithIndex,
